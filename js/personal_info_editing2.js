...
var submit_button = document.getElementById("perform_update");
...
/*Profiilin kuvan omasta erityisestä paikasta poistaminen*/
	if(document.getElementById("personal_photo").src ==	"http://localhost/My%20training%20website/images/question_mark.png")
	{
	$("#removing_photo").css("display","none");
	}
}